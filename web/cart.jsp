<%@page import="Model.entities.BookCart"%>
                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <a title="Remove this item" class="remove" href="Remove?id=<%=item.getId()%>">×</a>
                                        </td>  
                                        <td class="product-thumbnail">
                                            <a href="DetailServlet?id=<%=item.getId()%>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<%=item.getImageLink()%>"></a>
                                        </td>

                                        <td class="product-name">
                                            <a href="DetailServlet?id=<%=item.getId()%>"><%=item.getTitle()%></a> 
                                        </td>
                                    ...
                                    <%
                                        ...
                                        session.setAttribute(Common.Constant.COST_SESSION, totalPrice);
                                    %>
